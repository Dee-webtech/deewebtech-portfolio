    ...
    <footer style={{ background: '#111111', borderTop: '1px solid rgba(255,255,255,0.07)', padding: '52px 0 36px' }}>
      <div style={{ maxWidth: 1240, margin: '0 auto', padding: '0 28px', textAlign: 'center' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', gap: 22 }}>
          {/* GitHub */}
          <a href="https://github.com/Dee-webtech" aria-label="GitHub" style={{ color: '#6a6460', transition: 'color 0.2s' }}
          ...
          <a href="https://www.instagram.com/dee_webtech/" aria-label="Instagram" style={{ color: '#6a6460', transition: 'color 0.2s' }}
            onMouseEnter={e => (e.currentTarget.style.color = '#E87C1E')}
            onMouseLeave={e => (e.currentTarget.style.color = '#6a6460')}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <a href="https://x.com/dee_webtech" aria-label="Twitter" style={{ color: '#6a6460', transition: 'color 0.2s' }}
            onMouseEnter={e => (e.currentTarget.style.color = '#E87C1E')}
            onMouseLeave={e => (e.currentTarget.style.color = '#6a6460')}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          ...
          <a href="https://www.linkedin.com/in/delight-chinecherem/" aria-label="LinkedIn" style={{ color: '#6a6460', transition: 'color 0.2s' }}
            onMouseEnter={e => (e.currentTarget.style.color = '#E87C1E')}
            onMouseLeave={e => (e.currentTarget.style.color = '#6a6460')}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
